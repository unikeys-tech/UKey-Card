package com.softa.softb.utils.nfc;

import android.nfc.FormatException;
import android.nfc.NdefMessage;
import android.nfc.NdefRecord;

import com.softa.softb.utils.nfc.parse.NdefMessageParser;
...
public class SmartPoster implements ParseNFCRecord {
    /**
    ...
    public static SmartPoster parse(NdefRecord[] recordsRaw) {
        try {
            Iterable<ParseNFCRecord> records = NdefMessageParser.getRecords(recordsRaw);
